    ...
    public class ShipmentMapper
    {
        public Shipment MapShipment(DbDataReader reader)
        {
            return new Shipment
            {
                ...
                senderCustomerId = reader.GetGuid(reader.GetOrdinal("sender_customer_id")),
                ...
                weightKg = reader.GetDouble(reader.GetOrdinal("weight_kg")),
                heightCm = reader.GetDouble(reader.GetOrdinal("height_cm")),
                widthCm = reader.GetDouble(reader.GetOrdinal("width_cm")),
                lengthCm = reader.GetDouble(reader.GetOrdinal("length_cm")),
